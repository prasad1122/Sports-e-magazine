...
conn.execute('insert into contact values(?,?,?)',(name,message,status))
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2><center>Message has been sent  Succcessfull!!</center></h2>
...
<center><h1>Registration Succcessfull!!</h2></center>
